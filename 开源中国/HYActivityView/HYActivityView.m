...
- (void)setup
{
    ...
    // modify by liuyuan
    self.imageButton.backgroundColor = [UIColor colorWithRed:arc4random()%256/255.f green:arc4random()%256/255.f blue:arc4random()%256/255.f alpha:1.0];
    self.imageButton.layer.masksToBounds = YES;
    self.imageButton.layer.cornerRadius = 25;// 修剪 圆
